  ...
  return (
    <div className="flex items-center justify-between h-16 p-4">
      <div className="flex items-center gap-2">
        {!navStatus && (
          <div className="flex items-center gap-2">
            <Button variant={'ghost'} className="px-1.5 py-2" onClick={toggleNavStatus}>
              <Image src="/images/sidebar.png" alt="logo" width={24} height={24} />
            </Button>
            <Link href="/">
              <Button variant={'ghost'} className="px-1.5 py-2">
                <Image src="/images/write.png" alt="logo" width={26} height={26} />
              </Button>
            </Link>
          </div>
        )}
