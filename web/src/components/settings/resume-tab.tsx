    ...
    <TabsContent value="resume" className="space-y-4">
            ...
            <div key={index} className="space-y-4">
              <div className="flex gap-4 items-center">
                <Input
                  ...
                  placeholder="Company"
                  onChange={(e) => handleEmploymentHistoryChange(index, 'company', e.target.value)}
                />
                <Input
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Manage your education information for resume generation</CardDescription>
        </CardHeader>
